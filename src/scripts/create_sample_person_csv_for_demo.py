...
required_columns = [
    ...
    "last_modified",
    "last_modified_by",
]  # 'wikipedia_link','wikidata_id' are waiting for discussion
...
df.loc[df.shape[0]] = [
    ...
    "1234",
    "",
    "https://zh.wikipedia.org/wiki/%E4%B8%89%E6%AF%9B_(%E4%BD%9C%E5%AE%B6)",
    "",
    time.strftime("%Y-%m-%d", time.localtime()),
    "QG",
    "",
    "",
]  # Correct birthyear and deathyear are 1943 and 1991
