...
from src.scripts.authenticity_space import compare_to_openstreetmap, get_QID, get_coordinate_from_wikidata
...
class MyTestCase(unittest.TestCase):
    ...
    def test_it_should_return_empty_list(self):
        self.assertEqual(
            compare_to_openstreetmap({'SP0023': ['Shenyang', 'PL', 41.805699, 123.431472]}),
            [],
        )

    def test_it_should_return_list_of_not_match(self):
        self.assertEqual(
            compare_to_openstreetmap({'SP0025': ['Baiyangdian', 'PL', 38.941441, 115.969465]}),
